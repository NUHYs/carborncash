...
object Constants {
    ...
    fun getEmployeeData():ArrayList<Employee>{
        ...
        val emp2=Employee("브라운 슈가 에스프레소","6900₩", R.drawable.brownsugar)
        employeeList.add(emp2)
        val emp3=Employee("망고 용과 레모 리프레셔","6400₩", R.drawable.mangolemon)
        ...
        val emp6=Employee("딸기 라이트 요거트 블렌디드","6600₩", R.drawable.strawberry)
